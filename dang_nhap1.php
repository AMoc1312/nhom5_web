...
<body>
 ...
 <!--/ đầu đăng nhập /-->
  ...
  <div class="formdn">
  <div>	
  	<form method="post" action="dang_nhap_nguoi_dung_thuc_hien.php">
...
function myFunction() {
  ...
  if (x.type === "password") {
    ...
    <div style="margin-top: 10px;"> <a href="lay_lai_mat_khau.html" style=" margin-top: 10px;font-size: 15px; color: brown;"> Quên mật khẩu</a> 
     </div>
    </form>
  </div>
  </div>
