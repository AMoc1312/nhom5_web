...
<body>
    ...
    //echo $phan_loai;exit();
		...
		$sql = "
           INSERT INTO `tbl_review` (`id_review`, `id_reviewer`, `id_danh_muc`, `id_duong`, `so_nha`, `gio_mo_cua`, `gio_dong_cua`, `ten_mon`, `noi_dung`, `diem`, `gia_tb`, `gia_min`, `gia_max`, `anh_minh_hoa`, `ngay_dang`, `luot_xem`) VALUES (NULL, '".$ma_user."', '".$danh_muc."', '".$duong."', '".$so_nha."', '".$gio_mo."', '".$gio_dong."', '".$ten_mon."', '".$noi_dung."', '".$diem."', '".$gia_tb."', '".$gia_min."', '".$gia_max."', '".$anh_minh_hoa."', current_timestamp(), '0')
        ";
