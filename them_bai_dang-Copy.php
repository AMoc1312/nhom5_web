 ...
 width: 300px; height: auto;
  box-shadow: 0 0 3px rgba(0, 0, 0, 0.2), 0 0 10px rgba(0, 0, 0, 0.19);
      ...
      margin-top:230px;
       background-color:white;
       overflow: auto;
       z-index: 1034; font-size: 14px;position: fixed;
}
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Đăng bài</h1>
            <span class="color-text-a">Hãy chia sẻ cảm nhận chân thực nhất nhé ^^ Cảm ơn bạn rất nhiều</span>
          </div>
        </div>
          ...
          <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="blog_ca_nhan.php?id=<?php echo $ma_user;?>">Tài khoản</a>
              </li>
...
<!-- Thêm bài đăng đầu -->
<div id="khungBaiDang" style="border-style: solid; border-color: #ddd; margin-left: auto; margin-right: auto;border-width: 0.1px;padding: 20px;border-radius: 10px;">
