      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="grid-option">
            <form>
              <select onchange="getsapxep()" id="sapxep" class="custom-select">
              ...
              <script type="text/javascript">
                ...
                function getsapxep()
                {
                  var bien = document.getElementById("sapxep");
                    if(bien.value=="1")
                    {

                     window.location.href='review.php?id=1';
                    } 
                    else if(bien.value=="2")
                    {

                     window.location.href='review.php?id=2';
                    }
                     else if(bien.value=="3")
                    {

                     window.location.href='review.php?id=3';
                    }
                     else if(bien.value=="4")
                    {

                     window.location.href='review.php?id=4';
                    }
                     else if(bien.value=="5")
                    {

                     window.location.href='review.php?id=5';
                    }
                     else if(bien.value=="6")
                    {

                     window.location.href='review.php?id=6';
                    }
                     else 
                    {
                    ...
                    //  document.getElementById("sapxep").value = "1";
                }
              </script>
            </form>
          </div>
      ...
      <?php
        ...
        $ket_noi = mysqli_connect("localhost", "root", "", "nhom5");
         ...
         $id_order = (isset($_GET['id']) ? $_GET['id'] : '');
          ...
          {
        $sql = "
          SELECT * FROM `tbl_review` ORDER BY `ten_mon` ASC 
        ";
      } 
      else if($id_order==2)
      {
         $sql = "
          SELECT * FROM `tbl_review` ORDER BY `ten_mon` DESC 
        ";
      }
      else if($id_order==3)
        {
        $sql = "
          SELECT * FROM tbl_review ORDER BY COALESCE(gia_min,0) + COALESCE(gia_tb,0) ASC
        ";
      } 
      else if($id_order==4)
      {
         $sql = "
          SELECT * FROM tbl_review ORDER BY COALESCE(gia_min,0) + COALESCE(gia_tb,0) DESC
        ";
      }
       else if($id_order==5)
        {
        $sql = "
          SELECT * FROM `tbl_review` ORDER BY `ngay_dang` ASC 
        ";
      } 
      else if($id_order==6)
      {
         $sql = "
          SELECT * FROM `tbl_review` ORDER BY `ngay_dang` DESC 
        ";
      }
      else
      {
       ...
       <!--cuối kết nối-->
        <div class="col-md-4">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="<?php echo $row["anh_minh_hoa"];?>" alt="" class="img-a img-fluid">
            </div>
            ...
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                ...
                <div class="card-body-a">
                  ...
                  <a href="review.php" class="link-a">Xem chi tiết
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
                <div class="card-footer-a">
