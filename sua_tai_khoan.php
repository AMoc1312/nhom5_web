...
<body>
 ...
 <!--/ đầu đăng nhập /-->
  ...
  <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" style="margin-left: 350px">
                            <div class="card" >
                                <h5 class="card-header" style="text-align: center;"> cập nhật lại thông tin </h5>

                                <div class="card-body">                                 
                                 <form method="POST" action="sua_tai_khoan_thuc_hien.php" enctype="multipart/form-data">
                                 <?php
        // 1. Chuỗi kết nối đến CSDL
        $ket_noi = mysqli_connect("localhost", "root", "", "nhom5");
        mysqli_query($ket_noi, "SET NAMES 'UTF8'");

        // 2.Lấy ra đc id của duong sua
      //  $id_user = $_GET['1'];
        $id_user = 1;
        //echo $id_tin_tuc; exit();

        // 3. Viết câu lệnh SQL để lấy ra dữ liệu mong muốn
        $sql = "
                SELECT *
        ...
        // 4. Thực hiện truy vấn để lấy tin tức
        $ten_user=mysqli_query($ket_noi, $sql);

        // 5. Hiển thị dữ liệu web
        $row = mysqli_fetch_array($ten_user);
        
        ;?>
                                      <div class="form-group">
                                            <label for="txtUser">Họ và tên</label></br>
                                            <input  type="text" name="txtHoTen" placeholder="Nhập tên họ tên" value="<?php echo $row["ten"];?>" required  style="width: 580px">
                                        </div>
        
                                <div class="form-group">
                                            <label for="txtUser">Tên đăng nhập</label></br>
                                            <input  type="text" name="txtUser" placeholder="Nhập tên đăng nhập" value="<?php echo $row["ten_dang_nhap"];?>" required  style="width: 580px">
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail">Địa chỉ Email</label></br>
                                            <input id="inputEmail" type="email" name="txtEmail" placeholder="Nhập email" value="<?php echo $row["email"];?>" required    style="width: 580px">
                                        </div>
                                        <div class="form-group">
                                            <label for="txtMatKhau">Nhập mật khẩu </label></br>
                                            <input  type="password"  name="txtMatKhau" placeholder="Mật khẩu"  value="<?php echo $row["pass"];?>" required >
                                        </div>
                                        <div class="form-group">
                                            <label for="txtNhapLaiMatKhau">Nhập lại mật khẩu </label></br>
                                           <input  type="password"  name="txtNhapLaiMatKhau" placeholder="Mật khẩu"  value="<?php echo $row["pass"];?>" required >
                                        </div>
                                          <div class="form-group">
            ...
            ;?>" width="180px" height="auto">
                                        ...
                                        <div class="row">
                                                <p style="margin-left: auto;margin-right: auto;" class="text-right">
                                                    <input type= "submit" name="submit" value=" Cập nhật" style=" background-color: #b3897b;border-style: solid; border-width: 0px;text-align: center;">
                                                </p>
                                            
                                        </div> 
                                  <input type="hidden" name="txtID" value="<?php echo "1";?>"> 
                                    </form>
     </div>
