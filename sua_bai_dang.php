...
<?php   $ma_user = (isset($_SESSION['user_id']) ? $_SESSION['user_id'] : ''); ?>
    <?php
     ...
     // $id_review =;
      ...
      $sql1 = "
        SELECT `id_review`,`id_reviewer`,tbl_danh_muc.`id_danh_muc`,tbl_review.`id_duong`,`so_nha`,`gio_mo_cua`,`gio_dong_cua`,`ten_mon`,`noi_dung`,`diem`,`gia_tb`,`gia_min`,`gia_max`,tbl_review.`anh_minh_hoa`,`ngay_dang`,`luot_xem`,ten_danh_muc,ten_duong FROM tbl_review INNER JOIN tbl_duong ON tbl_review.`id_duong`=tbl_duong.id_duong INNER JOIN tbl_danh_muc ON tbl_danh_muc.id_danh_muc=tbl_review.id_danh_muc WHERE id_review= '6'
      ";
...
<div style="float: left;width: 70%; height: 500px; margin-left: auto; margin-right: auto;padding: 20px;">
    <form method="POST" action="sua_bai_dang_thuc_hien.php" enctype="multipart/form-data">
                                          <div class="">
                                                <label for="txtTenMon">Tên món</label>
                                                <input value="<?php echo $row1["ten_mon"];?>" type="text" class="form-control" name ="txtTenMon" placeholder="Tên món" required>
                                ...
                                <textarea style="height: 187px;border-radius: 20px;" class="form-control" name ="txtNoiDung"  placeholder="Viết nội dung" style="width: 100%;"><?php echo $row1["noi_dung"];?></textarea>
                            </div>
                                            <div style="width: 30%;" class="">
                                                <label for="txtDiem">Điểm</label>
                                                <input value="<?php echo $row1["diem"];?>"  min="0" max="10" type="number" class="form-control" name="txtDiem" placeholder="Điểm" >
                                              ...
                                              <div style="width: 30%;float: left;" class="">
                                                ...
                                                <input value="<?php echo $row1["gia_tb"];?>"  type="text" class="form-control" name="txtGiaTB" placeholder="VNĐ" >
                                                <div class="invalid-feedback">
                                                    Hãy nhập giá.
                                                </div>
                                            </div >
                                              <div style="width: 30%;float: left;" class="">
                                                ...
                                                <input value="<?php echo $row1["gia_min"];?>"  type="text" class="form-control" name="txtGiaMin" placeholder="VNĐ" >
                                                <div class="invalid-feedback">
                                                    Hãy nhập giá.
                                                </div>
                                            </div >
                                              <div style="width: 30%;float: left;" class="">
                                                ...
                                                <input value="<?php echo $row1["gia_max"];?>"  type="text" class="form-control" name="txtGiaMax" placeholder="VNĐ" >
                                                <div class="invalid-feedback">
                                                    Hãy nhập giá.
                                                </div>
                                            </div>  
                                             <div class="">
                                             <label for="txtAnhMinhHoa">Ảnh đại diện: </label>
                                            <input  type="file"  name="txtAnhMinhHoa" style="width: 100%">
                                                <img style="width: 10%;" src="<?php echo $row1["anh_minh_hoa"];?>">
                                            </div>                                    
</div>
...
<div style="float: left;border-style: solid;width: 30%; height: 400px;border-color: #ddd; margin-left: auto; margin-right: auto;padding: 20px;border-width: 0.1px;border-radius: 20px;">
   ...
   <div  class="">
    ...
    overflow-y: scroll;" class="form-control" name="txtDanhMuc"  placeholder="Danh mục" required >
      <option value="<?php echo $row1["id_danh_muc"];?>"><?php echo $row1["ten_danh_muc"];?></option>
                                            <option>-------------------</option>               
        <?php
        // 1. KẾT NỐI ĐẾN CSDL
        $ket_noi = mysqli_connect("localhost", "root", "", "nhom5");
    ...
    <option value="<?php echo $row1["id_duong"];?>"><?php echo $row1["ten_duong"];?></option>
                                            <option>-------------------</option>               
      ...
      ;?>
                                     ...
                                     <div class="">
                                                ...
                                                <input value="<?php echo $row1["so_nha"];?>"  type="text" class="form-control" name="txtSoNha" placeholder="số nhà" >
                                              
                                            </div> 
    
                                      <div style="width: 50%;float: left;" class="">
                                                <label for="txtGioMo">Giờ mở cửa</label>
                                                <input value="<?php echo $row1["gio_mo_cua"];?>" min="00:00" max="23:59" type="time" class="form-control" name="txtGioMo" placeholder="giờ mở cửa" >
                                                
                                            </div> 
                                      <div style="width: 50%;float: left;"  class="">
                                                <label  for="txtGioDong">Giờ đóng cửa</label>
                                                <input value="<?php echo $row1["gio_dong_cua"];?>" type="time" class="form-control" name="txtGioDong" placeholder="giờ đóng cửa" >
                                                
                                            </div> 
                                      
</div>
<div>
                                        <button type="submit" style="margin-top: 180px;margin-right: 50px;float:right;z-index: -1;font-size:14px; padding: 5px 15px;background-color: #ccb7b0;color: black;border-width: 0px;border-radius: 7px;font-size: 20px;" class="ed">cập nhật</button>
                                      </div>
                                       <input type="hidden" name="txtID" value="<?php echo $row["$id_review"];?>">
                                      </form>
</div>
<!-- Thêm bài đăng cuối -->
