    ...
    <label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
          ...
          <div class="box-comments" style="max-height: 500px; overflow-y: auto;">
            ...
            <form method="POST" action="./quan_tri_tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
                  <textarea name="txtBinhLuan" placeholder="Nhập bình luận..." required value=""  style="padding: 15px;width: 100%;border-style: solid;border-width: 0.1px; border-radius: 10px;clear: both;"></textarea>
      ...
      // 4. Thực thi câu lệnh lấy ra dữ liệu mong muốn
      $noi_dung_tin_tuc5 = mysqli_query($ket_noi, $sql5);

      // 5. Hiển thị dữ liệu lấy được lên màn hình
      $row5 = mysqli_fetch_array($noi_dung_tin_tuc5);
    ;?>
                  ...
                  <textarea name="txtBinhLuan3" placeholder="Nhập bình luận..." required style="padding: 15px;width: 100%;height:80px;border-style: solid;border-width: 0.1px; border-radius: 10px;clear: both;"><?php echo $row5["noi_dung"];?></textarea>

                  <button style="float:right;z-index: -1;font-size:14px; padding: 5px 15px;background-color: #ccb7b0;" class="ed"  ><a href="">Cập nhật</a></button>
                  <input type="hidden" name="txtIDcmt" value="$id_bl">
                  <input type="hidden" name="txtIDrv" value="$id_rv">
                  </div>
                           <?php
                          } else {
                          ?> 
                  ...
                  <textarea name="txtBinhLuan" placeholder="Nhập bình luận..." required value=""  style="padding: 15px;width: 100%;height:60px;border-style: solid;border-width: 0.1px; border-radius: 10px;clear: both;"></textarea>
