            ...
            <div  class="col-md-5 section-md-t3">
              <div class="agent-info-box">
                <div class="agent-title">
                  <div class="title-box-d">
                    <h3 class="title-d" style="font-size: 40px;"><?php echo $row["ten_mon"];?></h3>
                  </div>
                </div>
            ...
            <form method="POST" action="./quan_tri_tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
              ...
              <li> <!-- đầu commnent to -->
                ...
                <button  style="float: left;" class="ed" ><a href=""><img style="width:16px; " src="img/delete.cmt.png"></a></button>
                  ...
                  <button onclick="goicmt()" style="font-size: 16px; color:black;border-style: solid;border-width: 0px;background-color: white;" >Trả lời</button>
                  <script >
                  ...
                  <div id="mocmt" style="display: none; width: 100%;height:auto; border-width: 0px;margin-top: 10px;padding-right: 20px;">
                  <textarea name="txtBinhLuan" placeholder="Nhập bình luận..." required value=""  style="padding: 15px;width: 100%;border-style: solid;border-width: 0.1px; border-radius: 20px;clear: both;"></textarea>
              ...
              <li class="comment-children"> <!-- đầu rep commnent -->
                <div class="comment-avatar">
