...
<div id="myDropdown1" class="dropdown-content" style="z-index:1031; ">
   <a id="i1" href="blog_ca_nhan.php?id=<?php  session_start(); echo $_SESSION['user_id'];?>">Trang cá nhân</a>
    
    <a href="">Đăng bài</a>
    
     <button style="margin: 0px 15px;border-width: 0px; ">Thông báo</button>
    <a href="">Đã lưu</a>
