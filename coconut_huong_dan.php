...
<body>
      ...
      <div class="row">
         <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h3 class="title-single"> Giới thiệu</h3>
 ...
 <!--/ đầu đăng nhập /-->
  ...
  <h4><strong>Hướng dẫn tạo tài khoản</strong> </h4>
  <p style="text-align: justify;"> 
           viết nội dung giới thiệu
  </p>
  <h4><strong>Hướng dẫn lấy mật khẩu</strong> </h4>
  <p style="text-align: justify;"> 
           viết nội dung giới thiệu
  </p>
  <h4><strong>Nguyên tắc đăng bài</strong> </h4>
  <p style="text-align: justify;">
           viết nội dung giới thiệu
  </p>
  </div>
