...
<body>
    ...
    <div class="dashboard-main-wrapper">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Quản trị admin </h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị người dùng</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị admin</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Thêm mới admin</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Sửa tài khoản admin</h5>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="./quan_tri_admin_sua_thuc_hien.php" enctype="multipart/form-data">
                        <?php
                            ...
                            $sql = "
                                        SELECT id_quan_tri, ten, ten_dang_nhap,pass,anh_dai_dien
                                        FROM  tbl_user_admin
                                        WHERE id_quan_tri='" .$id_quan_tri. "'
                                    ";
                            ...
                            $noi_dung_tai_khoan = mysqli_query($ket_noi, $sql);

                            $product = $noi_dung_tai_khoan->fetch_assoc();
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <input type="text" class="form-control" name="txtHoTen" value="<?php echo $row["ten"];?>" required>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="txtTenDangNhap"  value="<?php echo $row["ten_dang_nhap"];?>" required>
                            ...
                            <div class="form-row">
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="txtPassword" value="<?php echo $row["pass"];?>"required>
                                    <div class="invalid-feedback">
                                        Hãy nhập password
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <?php  if (!empty($product["anh_dai_dien"])) { ?>
                                        <img src="img/<?= $product["anh_dai_dien"];?>" style="width: 20%" /><br/>
                                        <input type="hidden" name="image" value="<?= $product["anh_dai_dien"];?>">
                                    <?php }
                                    ?>

                                    <input type="file"name="txtAnhMinhHoa" >
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <button class="btn btn-primary" type="submit">Submit</button>
                                </div>
                            </div>
                            <input type="hidden" name="txtID" value="<?php echo $product["id_quan_tri"];?>">
                        </form>
                    </div>
                </div>
            </div>
