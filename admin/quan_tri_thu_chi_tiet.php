                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="quan_tri_thu.php" class="breadcrumb-link">Hộp thư</a></li>
                        ...
                        <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="card" id="align">
                                        ...
                                        <h3 style="margin-bottom: 0px;font-family: sans-serif;float: left;" class="card-header"><img style="margin: 0px 15px;width: 25px;float: left;" src="../documentation/img/mail.png"><?php echo $row["ho_ten"];?> (<i></i><?php echo $row["email"];?>)</h3>
                                    
                                        

                                        <div style="height: auto;" class="card-body">
                                            <h1 style="margin-left: 30px;;margin-bottom: 0px;font-family: sans-serif;" class="text-left"><?php echo $row["tieu_de"];?></h1>
                                            <p style="margin-right: 30px;" class="text-right"><?php echo date("d/m/Y - H:i:s",strtotime($row["ngay_gui"]));?></p>
                                            <div style="border-style: solid; border-width: 0.1px; border-color: #ddd; border-radius: 10px;height: auto; padding: 20px;margin: 0 30px;">
                                                <p class="text-left">Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui, dapibus pharetra risus semper non.
                                                Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui, dapibus pharetra risus semper non. Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui, dapibus pharetra risus semper non. Pellentesque vulputate arcu sed risus auctor tincidunt. Morbi eget massa turpis. Fusce aliquet dolor eu posuere tincidunt. Fusce ultricies luctus dui, dapibus pharetra risus semper non.  .</p>

                                            </div>
                                            <button style="border-radius: 17px; font-size: 15px; margin: 15px 30px 0px 30px;float: left;" class="btn btn-sm btn-outline-light"><a href="tra_loi_thuc_hien.php?id=<?php echo $row["id_gop_y"];?>">Xác nhận đã trả lời</button>
                                            <button style="border-radius: 17px; font-size: 15px; margin: 15px 30px 0px 30px;float: right;" class="btn btn-sm btn-outline-light"><a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=<?php echo $row["email"];?>&tf=1#">Gửi thư</button>
