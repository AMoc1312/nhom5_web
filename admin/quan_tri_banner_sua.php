                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> Quản trị liên kết </h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị liên kết</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị banner</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="./quan_tri_banner_sua_thuc_hien.php" enctype="multipart/form-data">
                        <?php
                            ...
                            $sql = "
                                        SELECT id_banner, noi_dung, link,anh_minh_hoa
                                        FROM  tbl_banner
                            ...
                            <div class="row" style="font-family: 'Poppins', sans-serif;font-weight: bold;">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="txtNoiDung"  value="<?php echo $row["noi_dung"];?>" required>
                                    </div>
                                </div>
                                 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    <label for="txtLink">link</label>
                                        <input type="text" class="form-control" name="txtLink" placeholder="Link" value="<?php echo $row["link"];?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                    <label for="validationCustom04">Ảnh minh họa</label>
                                    <?php  if (!empty($product["anh_minh_hoa"])) { ?>
                                        <img src="../img/<?= $product["anh_minh_hoa"];?>" style="width: 20%" /><br/>
                                        <input type="hidden" name="image" value="<?= $product["anh_minh_hoa"];?>">
                                    <?php }
                                    ?>
                            ...
                            <input type="hidden" name="txtID" value="<?php echo $product["id_banner"];?>">
                        </form>
                    </div>
                </div>
            </div>
