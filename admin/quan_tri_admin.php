                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="quan_tri_binh_luan.php" class="breadcrumb-link">Quản trị người dùng</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Quản trị quản trị admin</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <a href="quan_tri_admin_them_moi.php"><button style="float: right; " class="btn btn-sm btn-outline-light">Thêm người quản trị</button></a>
                                         <tr>
                            <td style="font-weight: bold; text-align: center;">STT</td>
                            <td style="width: 300px; font-weight: bold; text-align: center;">Họ và tên</td>
                            <td style="font-weight: bold; text-align: center;">Tên đăng nhập</td>
                            <td style="font-weight: bold; text-align: center;">Password</td>
                            <td style="font-weight: bold; text-align: center;">Ảnh đại diện</td>
                        ...
                        while ($row = mysqli_fetch_array($noi_dung)) {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $row["anh_dai_dien"];?>" style="width: 200px; height: auto;"></td>
                                <td><button class="btn btn-sm btn-outline-light"><a href="./quan_tri_admin_sua.php?id=<?php echo $row["id_quan_tri"];?>">Sửa</a></button></td>
                                <td>
                                    <button class="btn btn-sm btn-outline-light"> <a href="./quan_tri_admin_xoa.php?id=<?php echo $row["id_quan_tri"];?>">
