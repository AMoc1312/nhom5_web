...
<body>
	<?php
			...
			if($row["trang_thai"]==1)
			{
				$sql="UPDATE `tbl_rep_binh_luan` SET `trang_thai` = '0' WHERE `tbl_rep_binh_luan`.`id_rep` = '".$id_rep."'";
			}
			else
			{
				$sql="UPDATE `tbl_rep_binh_luan` SET `trang_thai` = '1' WHERE `tbl_rep_binh_luan`.`id_rep` = '".$id_rep."'";
			}
		...
		"
			<script type='text/javascript'>
				window.location.href='quan_tri_rep_binh_luan.php'
			</script>
		";
		;?>
</body>
