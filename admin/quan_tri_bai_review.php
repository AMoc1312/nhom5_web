        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Quản trị bài review</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Quản trị bài review</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="dashboard-short-list">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Bài review</h5>
                ...
                // 2. Lấy dữ liệu mong muốn
                $sql = "
                    SELECT tbl_user_reviewer.ten_dang_nhap, id_review,anh_minh_hoa,ngay_dang,ten_mon FROM `tbl_review` INNER JOIN tbl_user_reviewer ON tbl_review.id_reviewer=tbl_user_reviewer.id_reviewer ORDER BY `id_review` DESC
                ";
            ...
            ;?>
                <!-- ĐOẠN DỮ LIỆU LẶP ĐI LẶP LẠI -->
                                            <tr>
                                                ...
                                                <td><img src="../<?php echo $row["anh_minh_hoa"];?>" style="width: 60px; height: auto;"></td>
                                                <td ><?php echo $row["ten_mon"];?></td>
                                                <td><?php echo $row["ten_dang_nhap"];?></td>
                                                <td><?php echo date("d/m/Y - H:i:s",strtotime($row["ngay_dang"]));?></td>

                                                <td><a href="../review_chi_tiet.php?id=<?php echo $row["id_review"];?>"><button class="btn btn-sm btn-outline-light">Xem chi tiết</button></a></td>
