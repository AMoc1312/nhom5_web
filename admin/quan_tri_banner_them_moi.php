                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="POST" action="./quan_tri_banner_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                        <div class="row" style="font-family: 'Poppins', sans-serif;font-weight: bold;">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input type="url" class="form-control" name="txtLink" placeholder="Link" value="" required>
