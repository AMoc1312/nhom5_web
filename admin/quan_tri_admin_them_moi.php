                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="POST" action="./quan_tri_admin_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                        <div class="row" style="font-family: 'Poppins', sans-serif;font-weight: bold;">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="txtHoTen">Họ tên</label>
                                                <input type="text" class="form-control" name="txtHoTen" placeholder="Họ và tên" value="" required>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="txtTenDangNhap" placeholder="Username" aria-describedby="inputGroupPrepend" required>
