        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="./quan_tri_danh_muc_sua_thuc_hien.php" enctype="multipart/form-data">
                        <?php
                            ...
                            $sql = "
                                        SELECT id_danh_muc, ten_danh_muc, anh_minh_hoa
                                        FROM  tbl_danh_muc
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <input type="text" class="form-control" name="txtTenDanhMuc" value="<?php echo $row["ten_danh_muc"];?>" required>
                            ...
                            <input type="hidden" name="txtID" value="<?php echo $product["id_danh_muc"];?>">
                        </form>
                    </div>
                </div>
            </div>
