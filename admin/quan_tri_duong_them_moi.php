                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="quan_tri_tra_loi_binh_luan.php">Quản trị trả lời bình luận</a>
                                        </li>
                                       <!-- <li class="nav-item">
            ...
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Thêm mới đường</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Thêm mới đường</h5>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="./quan_tri_duong_them_moi_thuc_hien.php" enctype="multipart/form-dadta">
                                        <div class="form-row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                                <label for="txtTenDanhmuc"> Tên đường</label>
                                                <input type="text" class="form-control" name="txtTenDuong" placeholder="Đường" required>
