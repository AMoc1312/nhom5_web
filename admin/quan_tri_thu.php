    ...
    <div class="dashboard-main-wrapper">
       ...
       <div class="dashboard-header">
        ...
        <div class="dashboard-wrapper">
            ...
            ;?>
                <!-- ĐOẠN DỮ LIỆU LẶP ĐI LẶP LẠI -->
                 <!-- <td><a href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to=<?php echo $row["email"];?>&tf=1#">Trả lời</a></td> -->
                                            <tr>
                                                <th scope="row"><?php echo $i;?></th>
                                                <td><?php echo $row["ho_ten"];?></td>
                                                <td><?php echo $row["tieu_de"];?></td>
                                                <td><button class="btn btn-sm btn-outline-light"><a href="quan_tri_thu_chi_tiet.php?id=<?php echo $row["id_gop_y"];?>">Xem chi tiết</button></td>
                                                <td>
                                                    <?php
                          if ($row["trang_thai"] ==0) {
                            ?>
