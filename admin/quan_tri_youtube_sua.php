...
<body>
    ...
    <div class="dashboard-main-wrapper">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị youtube</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header">Sửa video</h5>
                    <div class="card-body">
                        <form class="needs-validation" novalidate method="POST" action="./quan_tri_youtube_sua_thuc_hien.php" enctype="multipart/form-data">
                        <?php
                            ...
                            <input type="hidden" name="txtID" value="<?php echo $row["id_youtube"];?>">
                        </form>
                    </div>
                </div>
            </div>
