...
<body>
    ...
    <div class="dashboard-main-wrapper">
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Quản trị bài đăng</h2>
                            <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị bài đăng</a></li>
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Quản trị đường</a></li>
                                        <li class="breadcrumb-item active" aria-current="page"> Sửa đường</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Sửa đường</h5>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="./quan_tri_duong_sua_thuc_hien.php" enctype="multipart/form-dadta">
                                            <?php
        ...
        $ten_duong=mysqli_query($ket_noi, $sql);

        // 5. Hiển thị dữ liệu web
        $row = mysqli_fetch_array($ten_duong);
        
        ;?>
                                        <div class="form-row">
                                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                                <label for="txtTenDuong"> Tên đường</label>
                                                <input type="text" class="form-control" name="txtTenDuong" value="<?php echo $row["ten_duong"];?>" required>
                                            ...
                                            <input type="hidden" name="txtID" value="<?php echo $row["id_duong"];?>"> 
                                          </form>
                                        </div>                                  
                                </div>
                            </div>
