        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Quản trị danh mục</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="dashboard-short-list">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Danh mục đồ ăn</h5>

                            <div class="card-body">
                            
                                <div class="table-responsive">
                                <a href="quan_tri_danh_muc_them_moi.php"><button style="float: right; " class="btn btn-sm btn-outline-light">Thêm danh mục</button></a>
            ...
            ;?>
                <!-- ĐOẠN DỮ LIỆU LẶP ĐI LẶP LẠI -->
                                            ...
                                            <button class="btn btn-sm btn-outline-light"><a href="./quan_tri_danh_muc_sua.php?id=<?php echo $row["id_danh_muc"];?>">Edit</button>
                                            <button class="btn btn-sm btn-outline-light"> <a  href="./quan_tri_danh_muc_xoa.php?id=<?php echo $row["id_danh_muc"];?>">
