            ...
            <div class="container-fluid  dashboard-content">
                ...
                <!-- ============================================================== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Thêm video</h5>
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="POST" action="./quan_tri_youtube_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                        <div class="row" style="font-family: 'Poppins', sans-serif;font-weight: bold;">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="txtNoiDung" placeholder="Content" aria-describedby="inputGroupPrepend" required>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input type="text" class="form-control" name="txtLink" placeholder="Link" value="" required>
