                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Quản trị youtube</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <a href="quan_tri_youtube_them_moi.php"><button style="float: right; " class="btn btn-sm btn-outline-light">Thêm video</button></a>
                                        <tr>
                            <td style="font-weight: bold; text-align: center;">STT</td>
                            <td style="width: 250px; font-weight: bold; text-align: center;">Nội dung</td>
                        ...
                        while ($row = mysqli_fetch_array($noi_dung)) {
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-sm btn-outline-light"><a href="./quan_tri_youtube_sua.php?id=<?php echo $row["id_youtube"];?>">Sửa</a></button></td>
                                <td>
                                    <button class="btn btn-sm btn-outline-light"> <a href="./quan_tri_youtube_xoa.php?id=<?php echo $row["id_youtube"];?>">
