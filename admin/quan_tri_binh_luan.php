       ...
       <div class="dashboard-header">
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Quản trị bình luận</h2>
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        <thead>
                                            <tr style="text-align: center;">
                                                ...
                                                <th style="width: 10%;">Tên bài</th>
                                                <th style="width: 10%;">Người bình luận</th>
                ...
                // 2. Lấy dữ liệu mong muốn
                $sql = "
                    SELECT id_binh_luan, tbl_user_reviewer.ten_dang_nhap, tbl_binh_luan.id_reviewer, tbl_review.ten_mon, tbl_binh_luan.id_review ,ngay_them, tbl_binh_luan.noi_dung, trang_thai FROM tbl_binh_luan INNER JOIN tbl_user_reviewer ON tbl_binh_luan.id_reviewer=tbl_user_reviewer.id_reviewer INNER JOIN tbl_review ON tbl_binh_luan.id_review=tbl_review.id_review ORDER BY id_binh_luan DESC
                ";
            ...
            ;?>
                <!-- ĐOẠN DỮ LIỆU LẶP ĐI LẶP LẠI -->
                                            <tr>
                                                ...
                                                <td><?php echo date("d/m/Y - H:i:s",strtotime($row["ngay_them"]));?></td>
                                                <td><a href="../review_chi_tiet.php?id=<?php echo $row["id_review"];?>"><button style="float: left;" class="btn btn-sm btn-outline-light">Xem</button></a></td>
                                                <td> 
                                                <?php
                          if ($row["trang_thai"] == 1) {
                            ?>
                            <a href="an_binh_luan.php?id=<?php echo $row["id_binh_luan"];?>"><button style="float: left;" type="submit" name="btnUpdate" class="btn btn-sm btn-outline-light">Đang hiện</button></a>
                          ...
                          {
                              ?>
                         <a href="an_binh_luan.php?id=<?php echo $row["id_binh_luan"];?>"><button style="float: left;" type="submit" name="btnUpdate" class="btn btn-sm btn-outline-light">Đang ẩn</button></a>
                            <?php 
                          };
                          ?>
