        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Quản trị người review</h2>
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Quản trị người review</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="dashboard-short-list">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Người review</h5>
                            ...
                            <td style="font-weight: bold; text-align: center;">Chỉnh sửa</td>
                        </tr>
                        <?php
                        ...
                        while ($row = mysqli_fetch_array($noi_dung)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-light"> <a href="./quan_tri_nguoi_review_xoa.php?id=<?php echo $row["id_reviewer"];?>">
