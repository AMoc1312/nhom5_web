...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">Trang cá nhân</h1>
            <span class="color-text-a">dkfjasj</span>
          </div>
        </div>
  ...
  <section class="contact">
    <div class="container" style="border-style: solid;border-width: 0.1px;">
      <div class="row">
        <div class="col-sm-12">
          
            
          <img style="width: 250px;" src="h1.png">
        </div>
