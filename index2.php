        ...
        <div class="row">
          <div class="col-md-12 mb-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-lg form-control-a" placeholder="Nhập tên món ăn...">
            </div>
          </div>
  ...
  <section class="section-agents section-t8">
    <div class="container">
      ...
      <?php
        ...
        "; */
        $sql="
          SELECT tbl_review.id_danh_muc,tbl_danh_muc.ten_danh_muc, COUNT(`id_review`) FROM `tbl_review` INNER JOIN tbl_danh_muc ON tbl_review.id_danh_muc=tbl_danh_muc.id_danh_muc GROUP BY tbl_review.id_danh_muc ORDER BY COUNT(`id_review`) DESC LIMIT 3
        ";
            ...
            <div class="card-overlay card-overlay-hover">
              <div class="card-header-d">
                <div class="card-title-d align-self-center">
                  <h3 style="margin-top: 150px;" class="title-d">
