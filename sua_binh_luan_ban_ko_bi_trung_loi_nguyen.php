...
<!--  cuối tài khoản-->
  ...
  <section class="agent-single">
    ...
    <label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
            ...
            <!-- đầu commnent -->
            <div id="cmt" style="padding-top: 60px;padding-bottom: 60px;" class="col-md-10 offset-md-1 col-lg-10 offset-lg-1">
          <div class="title-box-d">
      ...
      // 3. Lấy dữ liệu mong muốn
      $sql5 = "
      SELECT * FROM `tbl_binh_luan` INNER JOIN tbl_user_reviewer on tbl_binh_luan.`id_reviewer`=tbl_user_reviewer.`id_reviewer` WHERE id_binh_luan='".$id_bl."'
...
<form method="POST" action="sua_binh_luan_thuc_hien.php" enctype="multipart/form-data">
                  ...
                  <h4 class="comment-author"><?php echo $row5["ten_dang_nhap"];?></h4>
                ...
                <script type="text/javascript">
                  ...
                  <button type="submit" style="float:right;z-index: -1;font-size:14px; padding: 5px 15px;background-color: #ccb7b0;color: black;" class="ed"  > Cập nhật</button>
                  <input type="hidden" name="txtIDcmt" value="<?php echo $id_bl;?>">
